...
public class AddressType<TENANT extends Tenant<TENANT>, T extends Address> extends Type<TENANT, Address, T> {
	...
	public static AddressType<TenantA, AddressA> A = new AddressType<>(Tenant.A, AddressA.class, AddressA::new);
	public static AddressType<TenantB, AddressB> B = new AddressType<>(Tenant.B, AddressB.class, AddressB::new);
